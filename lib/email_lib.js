 ...
 * 
 */
module.exports.sendApiE2ECErrorEmail = function (error) {
  var mailOptions = {
      from: '"Chatster" <mwsoft01@mwsoft.nl>', // sender address
      to: 'n.karpovas@yahoo.com', // list of receivers
      subject: 'Chatster Api E2E C Error', // Subject line
      text: `Chatster E2E C Error`, // plain text body
 ...
 * 
 */
module.exports.sendNewApiE2ECIsUpEmail = function () {
  var mailOptions = {
      from: '"Chatster" <mwsoft01@mwsoft.nl>', // sender address
      to: 'n.karpovas@yahoo.com', // list of receivers
      subject: 'Chatster New Api E2E C Server Is Up', // Subject line
      text: `Chatster New Api E2E C Server Is Up`
  };
  // send mail with defined transport object
  transporter.sendMail(mailOptions, (error, info) => {
      if (error) {
